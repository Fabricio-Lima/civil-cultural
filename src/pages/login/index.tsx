...
export default function Login() {
    ...
    return (
        <Col className={`${styles.containerLogin} ${styles[theme]} col-12 p-0 m-0 row h-full`}>
            ...
            <Col className={`${styles.imgIllustration} col-6 d-none d-md-block p-0`}>
                <RiveComponent style={{ width: '100%', height: '100%', marginLeft: '-.5rem' }} />
            </Col>

            <Col className='col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-8 col-sm-12 d-flex justify-items-center align-items-center'>
                <Col className='col-11 mx-auto'>
                    ...
                    <Form>
                        <Form.Group className=" col-12 col-xxl-6 col-xl-8 col-lg-8 col-md-10 col-sm-12 mx-auto mb-4">
                            <FloatingLabel
                        ...
                        <Form.Group className="col-12 col-xxl-8 col-xl-8 col-lg-8 col-md-10 col-sm-12 mx-auto pt-2 pb-3 mt-5 mb-4">
                            <Link href='#' >
                                <a className={`${styles.formLink} link-primary float-end`}>{t('pages.login.forgot_password')}</a>
                            </Link>
                        </Form.Group>

                        <Form.Group className="col-12 col-xxl-8 col-xl-8 col-lg-8 col-md-10 col-sm-12 mx-auto d-grid gap-2 mb-4">
                            <Button type="button" className='text-uppercase' onClick={handleSubmit(submit)}> Entrar </Button>
                        </Form.Group>

                        <Form.Group className='col-12 my-2 text-center clearfix'>
                            <Link href='/register' >
